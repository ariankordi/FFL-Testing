...
DEFS := -DRIO_DEBUG -DRIO_NO_CONTROLLERS_WIN -DFFL_NO_FS -DFFL_NO_DATABASE_FILE -DFFL_NO_MIDDLE_DB -DFFL_NO_DATABASE_RANDOM -DFFL_NO_DRAW_MASK_ALPHA_VALUES -DFFL_ENABLE_NEW_MASK_ONLY_FLAG $(DEFS)
...
# Main source
SRC := src/main.cpp src/Model.cpp src/RootTask.cpp $(SHADER) src/DataUtils.cpp src/BodyModel.cpp src/RenderTexture.cpp src/HeadwearModel.cpp
